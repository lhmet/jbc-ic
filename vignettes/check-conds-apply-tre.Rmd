...
Para uma EMA alvo, pode obter-se a tabela de controle de aplicabilidade do TRE, com o código abaixo.
...
O que pode ser expandido para as demais EMAs alvo usando o código a seguir.
