...
hourly_INTERVAL = 30 # Intervalo de tempo, dias antes e depois do dia de referência
...
> Replicar este Rmd para os 2 exemplos do livro para analisar o efeito no viés
das diferentes estimativas da regressão.
