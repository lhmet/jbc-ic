...
O objetivo deste documento é determinar a disponibilidade de dados para a aplicação do Teste de Regressão Espacial (TRE). O TRE requer que os dados divididos em intervalos de tempo fixo (p.ex.: a cada 60 dias). 

Então antes de poder aplicar o teste precisamos conhecer:
