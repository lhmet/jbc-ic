---
title: "Aplicação do TRE para o período de maior disponibidade de dados das EMAs"
output: 
  html_notebook: 
    number_sections: yes
    toc: yes
...
Para uma EMA alvo, obtém a tabela de controle de aplicabilidade do TRE.

```{r}
check_disp_int <- check_aws_srt_feasibility(aws_target = "A882")
...
aws_targets
check_disp_int_inmet <- map_df(aws_targets, ~check_aws_srt_feasibility(aws_target = .x))
